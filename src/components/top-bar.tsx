...
export const TopBar: FC = () => {
  ...
  return (
    <div className={`fixed inset-x-0 top-0 h-18 border-b border-b-contrast-10 ${isAuthenticated ? 'bg-gray-500': 'bg-tranparent'} z-30 flex flex-row py-4 px-10`}>
           <p className={`text-3xl text-white font-extrabold font-sans ${isSignUpActive && 'text-black'}`}>apalux</p>
          {/* </div> */}
      <div className='flex flex-1 px-4 items-center'>
        ...
        <div className='flex flex-row items-center'>
          ...
          :
            ...
            shape='round'
            size='middle'
            onClick={()=>isSignUpActive ? navigate('signin') : navigate('signup')}
